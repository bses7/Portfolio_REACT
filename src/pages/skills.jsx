...
const Skills = () => {
  return (
    <section
      id="skills"
      className="experience-section pl-8 pr-0 relative min-h-screen"
    >
      ...
      <div className="flex justify-center items-center mt-8">
        <div className="flex lg:flex-row flex-col justify-center lg:space-x-48 lg:space-y-0 space-y-12 mx-auto">
          {softSkillsData.map((item, index) => (
            <div key={index} className="experience-item w-full mb-4">
              <div className="container flex justify-center">
                <div className="water shadow-xl flex w-[250px] h-[250px] bg-[#007777] rounded-full relative overflow-hidden before:content-[''] before:absolute before:w-[200%] before:h-[220%] before:-top[50%] before:left-[50%] before:bg-white after:content-[''] after:absolute after:w-[200%] after:h-[220%] after:-top[50%] after:left-[50%] after:bg-white">
                  <div className="relative text-center top-1/3 mx-auto  ">
                    <h3 className="text-xl font-semibold mb-2">{item.title}</h3>
                    <p className="text-md text-[#ebe6ff] mt-8 ">
                      {item.description}
                    </p>
                    <p className="text-sm text-[#ebe6ff] mt-2">
                      {item.additionalInfo}
                    </p>
                  </div>
                </div>
